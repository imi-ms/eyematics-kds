...
* Dokument                         1..1 BackboneElement "Dokument" "Metadaten und Referenzen eines Dokuments"
  ...
  * KlinischerKontext              0..1 BackboneElement "Klinischer Kontext" "Klinischer Kontext"
    * Einrichtungskontakt          0..* Reference(Encounter) "Einrichtungskontakt" "Aufenthalte und Besuche von Patient*innen bei Gesundheitseinrichtungen gemäß des Fall-Moduls (Einrichtungs-, Abteilungs- oder Versorgungsstellenkontakt)"
...
* Dokument                         -> "DocumentReference"
  ...
  * KlinischerKontext              -> "DocumentReference.context"
    * Einrichtungskontakt          -> "DocumentReference.context.encounter"
